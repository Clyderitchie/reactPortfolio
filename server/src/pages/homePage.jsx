...
import Resume from '../components/ui/homepage/img/resumePage.png';
        ...
        <HomeContent
            links={[
                <Link key={1} className="carousel-item active" to='/applications'>
                        ...
                        <img src={FizzBuzz} className="d-block w-100" alt="FizzBuzz screenshot" />
                ...
                <Link key={2} className="carousel-item " to='/projects'>
                        ...
                        <img src={Projects} className="d-block w-100" alt="Screenshot of projects page" />
                        <div className="carousel-caption d-none d-md-block">
                ...
                <Link key={3} className="carousel-item active" to='/resumes'>
                        ...
                        <img src={Resume} className="d-block w-100" alt="Screenshot of resume page" />
                        <div className="carousel-caption d-none d-md-block">
